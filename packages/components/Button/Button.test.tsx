...
describe('Button.vue', () => {
  ...
  test('basic button', async () => {
    ...
    // class
    expect(wrapper.classes()).toContain('gg-button--primary');
  ...
  it('should has the correct type class when type prop is set', () => {
    ...
    types.forEach(type => {
      ...
      expect(wrapper.classes()).toContain(`gg-button--${type}`);
    });
  });
  ...
  it('should has the correct size class when size prop is set', () => {
    ...
    sizes.forEach(size => {
      ...
      expect(wrapper.classes()).toContain(`gg-button--${size}`);
    });
  });
...
describe('ButtonGroup.vue', () => {
  test('basic button group', async () => {
    ...
    expect(wrapper.classes()).toContain('gg-button-group');
  });
  ...
  test('button group size', () => {
    ...
    sizes.forEach(size => {
      ...
      expect(buttonWrapper.classes()).toContain(`gg-button--${size}`);
    });
  });
  ...
  test('button group type', () => {
    ...
    types.forEach(type => {
      ...
      const buttonWrapper = wrapper.findComponent(Button);
      expect(buttonWrapper.classes()).toContain(`gg-button--${type}`);
    });
  });
